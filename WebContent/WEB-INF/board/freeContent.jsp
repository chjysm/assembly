...
<title>content</title>
        ...
        <style>
            *{margin:0 auto;}
            ...
            input[type="button"]{background: none; border: 2px solid black; border-radius: 5px;}
            input[type="button"]:hover{background-color: #e0e2e5;}
        </style>
    </head>
    <body>
        <!-- 고정메뉴 -->
        ...
        <div id="wrapper" class="container">
            ...
            <div class="footer row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-6 mt-2 mb-2"><input type="button" value="목록" class="listBtn"></div>	
