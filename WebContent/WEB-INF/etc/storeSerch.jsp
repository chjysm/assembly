  ...
  <head>
    ...
    <style>
        ...
        *{margin:0px auto; text-align: center; text-decoration: none; color:#000;}
        ...
        #results {font-size: 14px; font-weight: bold; border: 1px solid #ddd; padding: 15px; text-align: left; height: 50px; overflow-y: auto; max-width:800px; margin:50px auto; box-shadow:0 5px 10px -5px #333; width:100%}
    ...
    <div class="compact marquee-stacked" id="marquee">
      ...
      <div class="compact marquee container">
        ...
        <div id="div_start">
          ...
          <input type="text" placeholder="현재 계신곳의 주소를 타자로 입력하거나 음성으로 입력 해주세요!" class="final" id="final_span" contenteditable="true" name="addr"> <span class="interim" id=
          "interim_span"></span>
        </div>
    ...
    <script>
      ...
      $(function(){
     	 $("#nextBtn").on("click",function(){
     		 if($("#final_span").val()!=""){
     			location.href="goStoreSerch2.win?addr="+$("#final_span").val(); 
     		 }else{
     			 alert("주소를 입력 하세요!");
     		 }
     	 });
