...
<!----------machine view start----------------------------------------------->
				...
				<!-- carousel start-->
							...
							<!-- 		탭 화면 끝 -->
										<button id="slideBtn2" class="btn btn-primary mt-3 mb-3">장바구니</button>
	   							</div>
							    <div class="carousel-item">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 my text-center">
									    <button id="slideBtn1" class="btn btn-secondary mt-3 mb-3">이전단계</button>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 my text-center">
									    <button id="ordercancel" class="btn btn-primary mt-3 mb-3 mr-2">주문취소</button>
...
<script>
	...
	$('#close').on('click', function(){
		...
		$(location).attr("href", "mc_fin.kiosk");
	});
</script>
				<!-- carousel end-->
						</div>
