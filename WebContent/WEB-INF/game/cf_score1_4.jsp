		...
		<div class="row my text-center">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-3 my">
				<div class="row my">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 my">
						<form id="speakerForm">
							<div id="fake" style="display:none;">${coffee_hollys.get(Math.floor(Math.random()*(5+1))).menuName }</div>
							...
							$(function(){
								...
								$('.device-slider__item:nth-child(3)').on("click", function(){
									...
									$('.nextViewBtn').on('click', function(){
										$.ajax({
											url : "snack_value.coffeone",
											type : "post",
											data : {key1 : $('#fake').html(), key2 : sideNameY}
										}).done(function(resp){
											alert(resp);
										});
										$(location).attr('href', 'mc_beverage.coffeone');
									});
								});
							});
						</script>
