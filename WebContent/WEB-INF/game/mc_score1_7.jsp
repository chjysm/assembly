						...
						<div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 pl-4 pr-4">
							<div class="row lcd" id="mcClick">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
								 	<div class="row my">
								      	 <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 my text-center">
	  							 	 		<h1 class="h3 mt-4 mb-4">요구사항</h1>
											<p class="h5">${dto.takeIOM }</p>
											<p class="h5">${dto.burgerNameM }</p>
											<p class="h5">${dto.sideNameM }</p>
											<p class="h5">${dto.beverageNameM }</p>
										  </div>
							      	 <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 my text-center">
  							 	 		<h1 class="h3 mt-4 mb-4">내 답안</h1>
