...
.machine {
	width: 100%;
	height: 550px;
	background: url(Resources/img/mc_machine.png) no-repeat;
...
<!-- 스크립트 끝 -->
	...
	<div class="container mainPage">
		<div class="row my text-center mt-5 mb-5">
			<div
				class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center h1 pb-1 font-weight-bold">
				1단계 : 지시사항에 따라 품목을 선택해 보세요!
				...
				<div class="row my">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 my">
						<form id="speakerForm">
							...
							<textarea id="speakerTxt" class="text-center h3"
								style="width: 100%; height: 100%; border: none; background: none; display: block;"
								disabled></textarea>
							<script>
								document.getElementById('speakerTxt').value = document
										.getElementById('fake').innerText;
							</script>
							<button id="play" class="btn btn-primary btn-lg mt-1 mb-3"
								type="submit">
								<img src="Resources/img/sound.png" />&nbsp;버튼을 눌러 소리로 들어보세요
							</button>
						...
						<div class="row my">
							<div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 pl-4 pr-4">
								<div class="row lcd" id="mcClick">
									...
									<div
										class="col-lg-12 col-md-12 col-sm-12 col-xs-12 h1 font-weight-bold p-2">
										<a class="text-white" href="getCode.kiosk">주문하시려면 터치하세요</a><span
											class="animated infinite bounce"><img
											src="Resources/img/pointer.png" width="50" height="50"></span>
									</div>
								</div>
							</div>
							<div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 my card">
								<img class="cardImg" src="Resources/img/card.png" width="230"
									height="500">
							</div>
						</div>
					</div>
