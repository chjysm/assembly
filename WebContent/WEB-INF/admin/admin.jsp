...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
        ...
        <html>
                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div
                                                     class="text-xs font-weight-bold text-primary text-uppercase mb-1">금일의 방문자</div>
                                ...
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div
                                                     class="text-xs font-weight-bold text-success text-uppercase mb-1">총 기부액</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"
                                ...
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div
                                                     class="text-xs font-weight-bold text-info text-uppercase mb-1">맥도날드 학습 프로그램 진행 총 횟수</div>
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col-auto">
         ...
         <!-- ============================= DB에 햄버거 메뉴 데이터 갱신 ===========================-->
                    <button id="btn1">Burger_morning 데이터 삽입</button><p id="p1"></p>
					<button id="btn2">Happy_snack 데이터 삽입</button><p id="p2"></p>
					<button id="btn3">Cafe_desert 데이터 삽입</button><p id="p3"></p>
					<button id="btn4">메뉴 삭제</button><p id="p3"></p>
					<script>
